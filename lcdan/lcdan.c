...
#define PORTWxLCDAN_RS PORTB
#define PORTRxLCDAN_RS PINB
#define CONFIGIOxLCDAN_RS DDRB
#define PINxLCDAN_RS 1
...
#define PORTWxLCDAN_D4 PORTC
#define PORTRxLCDAN_D4 PINC
#define CONFIGIOxLCDAN_D4 DDRC
#define PINxLCDAN_D4 4

#define PORTWxLCDAN_D5 PORTC
#define PORTRxLCDAN_D5 PINC
#define CONFIGIOxLCDAN_D5 DDRC
#define PINxLCDAN_D5 5

#define PORTWxLCDAN_D6 PORTC
#define PORTRxLCDAN_D6 PINC
#define CONFIGIOxLCDAN_D6 DDRC
#define PINxLCDAN_D6 6

#define PORTWxLCDAN_D7 PORTC
#define PORTRxLCDAN_D7 PINC
#define CONFIGIOxLCDAN_D7 DDRC
